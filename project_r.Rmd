...
plot(job_data$project_lang,job_data$expert_experience )



################################################################
  
barplot( table(job_data$project_experience), horiz = TRUE)

ggplot(job_data$expert_province,job_data$expert_experience )
